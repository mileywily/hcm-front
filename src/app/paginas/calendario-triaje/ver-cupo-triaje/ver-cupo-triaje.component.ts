...
@Component({
  selector: 'app-ver-cupo-triaje',
  templateUrl: './ver-cupo-triaje.component.html',
  styleUrls: ['./ver-cupo-triaje.component.scss'],
})
export class VerCupoTriajeComponent implements OnInit {

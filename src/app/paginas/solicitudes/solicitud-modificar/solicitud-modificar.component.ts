...
@Component({
  selector: 'app-solicitud-modificar',
  templateUrl: './solicitud-modificar.component.html',
  styleUrls: ['./solicitud-modificar.component.scss'],
  providers: [MessageService,ConfirmationService]
})
export class SolicitudModificarComponent implements OnInit {

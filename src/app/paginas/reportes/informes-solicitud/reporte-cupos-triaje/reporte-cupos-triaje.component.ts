...
@Component({
  selector: 'app-reporte-cupos-triaje',
  templateUrl: './reporte-cupos-triaje.component.html',
  styleUrls: ['./reporte-cupos-triaje.component.scss'],
  providers: [MessageService]
})
export class ReporteCuposTriajeComponent implements OnInit {
  ...
  { 
    ...
    this.cols = [
      ...
      { field: 'fecha_atencion', header: 'Recepción', width: '8%' },
...
fullDropdownEstadoOrden() {
  ...
  this.detalleSolicitudService.ReportCuposTriaje(this.parametros)
  .toPromise()
  .then(results => {
...
exportExcel() {
  ...
  this.reporteMedico = this.reporte.map(col => ({
    ...
    grupo: col.grupo,
    servicio: col.servicio_nombre,
    telefono: col.telefono,
    fecha_recepcion: col.fecha_atencion,

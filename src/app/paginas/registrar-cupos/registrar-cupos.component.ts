...
@Component({
  selector: 'app-registrar-cupos',
  templateUrl: './registrar-cupos.component.html',
  styleUrls: ['./registrar-cupos.component.scss'],
  providers: [DatePipe, MessageService, ConfirmationService],
})
export class RegistrarCuposComponent implements OnInit {
  title: string;
  es: any;
  submitted: boolean;
  ...
  ngOnInit() {
    ...
    //console.log("TIPO SOLICITUD Registrar calendario::::::: " , this.menuService.getTipoSolicitud());
    //console.log("TIPO ATENCION Registrar calendario::::::: " , this.menuService.getTipoAtencion());
  }

...
@Component({
  selector: 'app-registrar-cupos-lab',
  templateUrl: './registrar-cupos-lab.component.html',
  styleUrls: ['./registrar-cupos-lab.component.scss'],
  providers: [DatePipe, MessageService, ConfirmationService],
})
export class RegistrarCuposLabComponent implements OnInit {
  title: string;
  es: any;
  submitted: boolean;

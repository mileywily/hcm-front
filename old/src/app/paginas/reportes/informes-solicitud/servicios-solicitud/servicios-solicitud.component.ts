...
@Component({
  selector: 'app-servicios-solicitud',
  templateUrl: './servicios-solicitud.component.html',
  styleUrls: ['./servicios-solicitud.component.scss'],
  providers: [DatePipe,MessageService]
})
export class ServiciosSolComponent implements OnInit {
  ...
  constructor(
    ...
    this.cols = [
      ...
      { field: 'solicitud_id', header: 'Solicitud', width: '8%' },
    ...
    .then((results) => {
      ...
      this.title = 'Solicitudes de Servicio : ' + this.tipoSolicitudSelected.nombre + '-' +  this.tipoAtencion.nombre ;
    })
    .catch((err) => {
      console.log(err);
    });

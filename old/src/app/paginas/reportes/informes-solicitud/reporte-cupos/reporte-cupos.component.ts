...
@Component({
  selector: 'app-reporte-cupos',
  templateUrl: './reporte-cupos.component.html',
  styleUrls: ['./reporte-cupos.component.scss'],
  providers: [MessageService]
})
export class ReporteCuposComponent implements OnInit {
...
fullDropdownEstadoOrden() {
  ...
  this.detalleSolicitudService.getRequestsReportCuposByParametros(this.parametros)
  .toPromise()
  .then(results => {

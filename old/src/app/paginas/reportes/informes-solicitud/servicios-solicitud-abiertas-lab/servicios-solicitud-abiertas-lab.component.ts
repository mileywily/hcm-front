...
@Component({
  selector: 'app-servicios-solicitud-abiertas-lab',
  templateUrl: './servicios-solicitud-abiertas-lab.component.html',
  styleUrls: ['./servicios-solicitud-abiertas-lab.component.scss'],
  providers: [DatePipe,MessageService]
})
export class ServiciosSolicitudAbiertasLabComponent implements OnInit {
 ...
 // servicioSolicitado: ServicioEspecialidadService;
  ...
  constructor(
    ...
    this.cols = [
      ...
      { field: 'nombre_examen', header: 'Examen', width: '5%' },
...
fullDropdownUser() {
  ...
  this.detalleSolicitudService.ReportByParametrosSolicitudesAbiertasLab(this.parametros)
  .toPromise()
  .then(results => {

...
@Component({
  selector: 'app-reporte-orden-lab',
  templateUrl: './reporte-orden-lab.component.html',
  styleUrls: ['./reporte-orden-lab.component.scss'],
  providers: [MessageService]
})
export class ReporteOrdenLabComponent implements OnInit {
  ...
  constructor(
    ...
    this.cols = [
      ...
      { field: 'fecha_recepcion', header: 'F.Recepcion', width: '5%' },
...
fullDropdownUser() {
  ...
  this.detalleSolicitudService.Reporte_Orden_Laboratorio(this.parametros)
  .toPromise()
  .then(results => {

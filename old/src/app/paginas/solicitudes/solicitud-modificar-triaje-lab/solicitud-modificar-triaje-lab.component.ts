...
@Component({
  selector: 'app-solicitud-modificar-triaje-lab',
  templateUrl: './solicitud-modificar-triaje-lab.component.html',
  styleUrls: ['./solicitud-modificar-triaje-lab.component.scss'],
  providers: [MessageService,ConfirmationService]
})
export class SolicitudModificarTriajeLabComponent implements OnInit {
  ...
  codRolLaboratorioCancelarSolicitud: string;


  /* Habilitar los items del menu según rol */
  activarBotonModificarSolicitudLaboratorio: boolean = false;
  activarBotonCancelarSolicitudLaboratorio: boolean = false;
  ...
  ngOnInit(): void 
  {
    ...
    this.codRolLaboratorioCancelarSolicitud = this.rolesService.getCodRolLaboratorioCancelarSolicitud();
       
    this.activarBotonModificarSolicitudLaboratorio = this.srvRolesByUser.buscarRolPorCodigo(this.codRolLaboratorioModificarSolicitud).length > 0 ? true : false;
    this.activarBotonCancelarSolicitudLaboratorio = this.srvRolesByUser.buscarRolPorCodigo(this.codRolLaboratorioCancelarSolicitud).length > 0 ? true : false;
...
setFiltros(){
  ...
  consultar()
  {
     ...
     this.detalleSolicitudService.Rep_solicitud_modificar_triaje_lab(this.parametros)
      .toPromise()
      .then(results =>
        {

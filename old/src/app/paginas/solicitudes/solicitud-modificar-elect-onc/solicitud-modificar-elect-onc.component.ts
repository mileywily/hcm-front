...
@Component({
  selector: 'app-solicitud-modificar-elect-onc',
  templateUrl: './solicitud-modificar-elect-onc.component.html',
  styleUrls: ['./solicitud-modificar-elect-onc.component.scss'],
  providers: [MessageService,ConfirmationService]
})
export class SolicitudModificarElectOncComponent implements OnInit {
  ...
  fullDropdownTipoOrden() {
    this.tipoAtencionService.getAllByTipoSolicitud(this.menuService.getTipoSolicitud())
      ...
      .then((results) => {
        ...
        this.tipoAtencion =  this.tipoOrdenes[0].tipo_atencion_id;

...
@Component({
  selector: 'app-solicitud-servicio-triaje',
  templateUrl: './solicitud-servicio-triaje.component.html',
  styleUrls: ['./solicitud-servicio-triaje.component.scss'],
  providers: [MessageService,ConfirmationService]
})
export class SolicitudServicioTriajeComponent implements OnInit {
  ...
  constructor(
    ...
    private diagnoticoService : DiagnosticoService,
  ...
  crearOrden() {
    //El selected en este caso corresponde al elemento seleccionado en la tabla de la vista
      this.navigate('orden-servicio-triaje', this.solicitud.solicitud_id, this.tipoSolicitud.tipo_solicitud_id, this.solicitud.especialidad_id);
  }
